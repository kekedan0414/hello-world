...
42 7.29，必须要有一个清晰的规划。并且需要认识自己的差距，勇于面对自己的性格，心里缺陷，逼迫自己，走出舒适区。
         规划：1、本职工作，做好。
               2、每天坚持写计划以及总结。
               3、在麒麟做服务器OS，华为光模块ATE架构，道通OTX统一测试平台，都是服务端的，因此服务器架构师最符合自己的职业经历，也符合未来的职业规划，因此现在需要朝这个方向努力----服务器架构师！
               4、首先要做到专业技能过硬，然后再是业务场景，最后才是广阔的视野。
               5、聚焦！聚焦！聚焦！利出一孔，花精力把一件事情做好！
                  1、总的方向：服务器架构师，职位一定要高，以后不再做琐事。
                  2、服务器架构师需要懂哪些知识，为什么需要这些知识，能解决什么问题？
                  3、比如消息队列MQ，Redis缓存，Zookeeper，微服务SpringCloud等等。
                  4、先后顺序：1、Redis缓存，
                               2、MQ，
                               3、Zookeeper
                               4、netty编程
                               5、底层的epoll原理，
                               6、分布式算法raft，paxos等，
                               7、Spring，SpringCloud
         缺陷：1、内心胆小脆弱：害怕看招聘信息，机会需要自己无时无刻地寻找，而不是等所有知识准备好再去寻找！
               2、改进措施：每天坚持看招聘网站，这样不仅可以直视自己的差距，也可以锻炼自己坚韧的性格，强大的内心。
         【今日计划】：Redis原理，实操，集群，各种应用场景，高并发存在的问题等等。

1 9.03 git每天练一练
2 9.04 git每日两联系 second
3 9.05
4 9.06
5 9.07
6 9.08
